...
static CGFloat const kDefaultCardViewHeight = 70.f;
static CGFloat const kDefaulInset = 15.f;
...
- (instancetype)initCardAlertWithTitle:(NSString*)title
    ...
    if (self) {
        ...
        self.iconImageSize = _iconImage == nil ? CGSizeZero : CGSizeMake(28.f, 28.f);
...
- (void)constructAlertCardView {
    ...
    [[self blurView] setFrame:alertView.bounds];
    [self blurView].backgroundColor = _alertViewBackgroundColor;
    [[self blurView] setAutoresizingMask:UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight];
//    [alertView insertSubview:[self blurView] atIndex:0];
    [alertView addSubview:[self blurView]];
    ...
    if(self.messageLabelHeight == 0){
        titleLabel.center = CGPointMake(self.view.frame.size.width  / 2 + 15,
